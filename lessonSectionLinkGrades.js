...
if (window.location.href.indexOf("pageid=-9") > -1) {
        ...
        $('.boxaligncenter a:nth-last-child(2)').attr('href', $('ol.breadcrumb li:nth-last-child(2) > a').attr('href'));
      //  $('.boxaligncenter p').first().before('<h5>You have completed the activity <i class="fa fa-thumbs-o-up" aria-hidden="true"></i>, Where to next?</h5>');
        $('.boxaligncenter .center').first().before('<h5>You have completed the activity <i class="fa fa-thumbs-o-up" aria-hidden="true"></i>, Where to next?</h5>');
       // $('.boxaligncenter p').first().after('<ul style="color:black;"><li><i class="fa fa-hand-o-left" aria-hidden="true"></i> You can review this lesson material again before continuing (if made available in this lesson)</li><li> Or you can continue onto the next activity (if made available in this lesson) <i class="fa fa-hand-o-right" aria-hidden="true"></i></li><li>Or return to the section this lesson is part of <i class="fa fa-reply" aria-hidden="true"></i></li></ul>');
        $('.boxaligncenter .center').first().after('<ul style="color:black;"><li><i class="fa fa-hand-o-left" aria-hidden="true"></i> You can review this lesson material again before continuing (if made available in this lesson)</li><li> Or you can continue onto the next activity (if made available in this lesson) <i class="fa fa-hand-o-right" aria-hidden="true"></i></li><li>Or return to the section this lesson is part of <i class="fa fa-reply" aria-hidden="true"></i></li></ul>');
