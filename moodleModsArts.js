	...
	*/
	...
	$(".block-region .type_course a").each(function(){
		if($(this).text().match(/Restore/)){
			...
			if(userName == "Sajjad Hossain" || userName == "Andrew Junor" || userName == "Carmen Sapsed" || userName == "Lily Nguyen" || userName == "Ross Mc Queen" || userName == "Josephine Hook"){
			...
			if(userName == "Carmen Sapsed" || userName == "Josephine Hook" || userName == "Ross Mc Queen"|| userName == "Sajjad Hossain" || userName == "Lily Nguyen" ||userName == "Andrew Williams" ||userName == "Andrew Junor"){
